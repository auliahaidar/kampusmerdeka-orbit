...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('Sarsa. Sichkar Valentyn')
    ...
    def build_environment(self):
        ...
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        ...
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 7, pixels, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 2, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 5, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 6, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        ...
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 2, pixels * 7, anchor='nw', image=self.obstacle8_object)
        # Obstacle 15
        ...
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 3, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 7, pixels * 3, anchor='nw', image=self.obstacle2_object)
